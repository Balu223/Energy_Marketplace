    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Product_Id", "CreatedDate", "Current_Quantity", "Initial_Quantity", "Price_Per_Unit", "Product_Name", "Transaction_Id", "Unit", "UpdatedDate" },
                values: new object[,]
                {
                    { 1, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1000, 1000, 150.00m, "Electricity", null, 0, null },
                    { 2, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 500, 500, 45.00m, "Natural Gas", null, 1, null },
                    { 3, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 200, 200, 280.00m, "Crude Oil", null, 2, null }
                });
